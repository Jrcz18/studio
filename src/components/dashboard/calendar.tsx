                                    ...
                                    <div key={unit.id} className="unit-cell">
                                        <div style={{display: 'flex', alignItems: 'center'}}>
                                            <div style={{
                                                ...
                                                height: 12,
                                                borderRadius: '50%',
                                                backgroundColor: unitColorMap.get(unit.id!),
                                                marginRight: 8,
                                                flexShrink: 0
                                            }} />
                                            <div>
                     ...
                     <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
                        {units.map(unit => (
                            <div key={unit.id} style={{ display: 'flex', alignItems: 'center' }}>
                                <div style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: unitColorMap.get(unit.id!), marginRight: '6px' }}></div>
                                <span style={{ fontSize: '12px', fontWeight: 500 }}>{unit.name}</span>
                            </div>
                        ))}
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <div style={{ width: '12px', height: '12px', borderRadius: '2px', border: '1px solid #ccc', marginRight: '6px' }}></div>
